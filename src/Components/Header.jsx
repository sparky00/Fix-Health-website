...
<div className="mx-auto flex w-full items-center justify-between px-4 py-6 sm:px-6 lg:px-24">
        <div className="inline-flex items-center space-x-2">
          ...
          <span className="font-bold">Fix Health</span>
        </div>
    ...
    <div className="mt-24 mx-auto max-w-7xl lg:grid lg:grid-cols-12 lg:gap-x-8 lg:px-8">
      <div className="flex flex-col justify-center px-4 py-12 md:py-16 lg:col-span-7 lg:gap-x-6 lg:px-6 lg:py-24 xl:col-span-6">
        ...
        <h1 className="mt-24 text-3xl font-bold tracking-tight text-black md:text-4xl lg:text-6xl">
  ...
  <div className="flex flex-col bg-black space-y-8 pb-10 pt-12 text-center">
          ...
          Empowering Wellness: Uncomplicated and Transparent Pricing for Your Physiotherapy Journey
          </p>
        </div>
  </>
  )
